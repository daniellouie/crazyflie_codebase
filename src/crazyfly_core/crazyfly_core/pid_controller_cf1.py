...
class PIDControllerCF1(Node):
    def __init__(self):
        super().__init__('pid_controller_cf1')
        ...
        self.create_subscription(
            PoseStamped,
            '/cf1_cmd',  # Commanded position from clusterController
        ...
        self.orientation_quat = [0.0, 0.0, 0.0, 0.1]
        ...
        self.hover = 38000 #originally 38000 11/19 
        ...
        self.k_p_x = 6.5
        self.k_i_x = 1.3
        self.k_d_x = 6.6  #originally 4.0 (feb 12)
        self.max_pitch = 3.0
        self.min_pitch = -3.0
    ...
    def calculate_yawrate(self):
        ...
        rot_error = (self.target_orientation - yaw + 180) % 360 - 180    # NOTE: logic is changed here 8/4/25
        yawrate = np.clip(self.k_p_rot * rot_error, self.min_yawrate, self.max_yawrate)
    ...
    #     self.cur_x_error = self.commanded_position[2] - self.current_position[2]
    ...
    #     # P term
    #     self.cur_z_error = self.commanded_position[0] - self.current_position[0]
...
def main(args=None):
    ...
    pid_controller_cf1 = PIDControllerCF1()
